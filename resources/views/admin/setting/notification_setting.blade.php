                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="customer_app_id" value="{{ $notification_setting->customer_app_id }}" required class="form-control text_transform_none">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="customer_auth_key" value="{{ $notification_setting->customer_auth_key }}" required class="form-control text_transform_none">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-12">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="customer_api_key" value="{{ $notification_setting->customer_api_key }}"  required class="form-control text_transform_none">
                                            </div>
                                        </div>
