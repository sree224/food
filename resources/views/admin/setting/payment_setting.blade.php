                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="stripe_publish_key" value="{{ $PaymentSetting->stripe_publish_key }}" required class="form-control text_transform_none">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="stripe_secret_key" value="{{ $PaymentSetting->stripe_secret_key }}" required class="form-control text_transform_none">
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="paypal_production" value="{{ $PaymentSetting->paypal_production }}" required class="form-control text_transform_none">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="paypal_sendbox" value="{{ $PaymentSetting->paypal_sendbox }}" required class="form-control text_transform_none">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="paypal_secret_key" value="{{ $PaymentSetting->paypal_secret_key }}" required class="form-control text_transform_none">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="paypal_client_id" value="{{ $PaymentSetting->paypal_client_id }}" required class="form-control text_transform_none">
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="razorpay_publish_key" value="{{ $PaymentSetting->razorpay_publish_key }}" required class="form-control text_transform_none">
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="public_key" value="{{ $PaymentSetting->public_key }}" required class="form-control text_transform_none">
                        </div>
                    </div>
