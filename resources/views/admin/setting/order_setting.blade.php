                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <select class="form-control" name="delivery_charge_type">
                                <option value="order_amount" {{ $orderData->delivery_charge_type == 'order_amount' ? 'selected' : '' }}>{{__('order amount')}}</option>
                                <option value="delivery_distance" {{ $orderData->delivery_charge_type == 'delivery_distance' ? 'selected' : '' }}>{{__('Delivery distance (KM)')}}</option>
                            </select>
                        </div>
                    </div>
                    <?php
