                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="notification_content" id="notification_content" name="notification_content" class="form-control text_transform_none" cols="30" rows="10">{{ $item->notification_content }}</textarea>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="mail_content" class="form-control textarea_editor text_transform_none" cols="10" rows="10" id="mail_content">{{ $item->mail_content }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
