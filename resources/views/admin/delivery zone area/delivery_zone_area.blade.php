                    ...
                    <div class="row">
                        <div class="card w-75">
                            <div class="card-body">
                                ...
                                <a href="javascript:void(0);" class="btn btn-primary float-right" data-toggle="modal" data-target="#show_delivery_person">{{__('View delivery person')}}</a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<div class="modal fade bd-example-modal-lg" id="edit_delivery_zone" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ __('Edit Area') }}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
