            ...
            <div class="card-body">
                <form class="container-fuild" action="{{ url('admin/promo_code/'.$promoCode->id) }}" method="post"  enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <input type="number" min=1 name="flatDiscount" class="form-control @error('flatDiscount') is_invalide @enderror" id="flatDiscount" placeholder="{{__('Enter Flat Discount In Amount')}}" value="{{ $promoCode->flatDiscount }}"></div>
