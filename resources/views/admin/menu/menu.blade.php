        ...
        <div class="modal-content">
            <form id="update_submenu_form" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="form-control-label">{{__('Item price')}}<span class="text-danger">&nbsp;*</span></label>
                        <input class="form-control text_transform_none @error('price') is-invalid @enderror" name="price" type="number" min=1 placeholder="{{__('Item Price')}}" id="update_price" required value="{{ old('price') }}">
