...
<section class="section">
    ...
    <div class="section-body">
        ...
        <p class="section-lead">{{__('Custimization add, edit')}}</p>
        <div class="card">
                                                        ...
                                                        <tbody id="{{'custom'.$custimization_type->id}}">
                                                            ...
                                                            @if ($items)
                                                                @foreach ($items as $item)
                                                                    <tr>
                                                                        ...
                                                                        @if ($loop->iteration == 1)
                                                                            <td>
                                                                                <button type="button" class="btn btn-primary update_custimization" onclick="update_custimization({{$custimization_type->id}},'{{ str_replace(' ', '_', strtolower($custimization_type->name)) }}')">+</button>
                                                                            </td>
                                                                        @else
                                                                            <td>
                                                            ...
                                                            @else
                                                                <tr id="{{'custom'.$custimization_type->id}}">
                                                                    ...
                                                                    <td>
                                                                        <button type="button" class="btn btn-primary" onclick="update_custimization({{$custimization_type->id}},'{{ str_replace(' ', '_', strtolower($custimization_type->name)) }}')">+</button>
                                                                    </td>
                                                                </tr>
                                                            @endif
                                                        </tbody>
